...
if load_iter == 0:
    ...
    netG_A2B.load_state_dict(torch.load(os.path.join(output_weights_path, 'netG_A2B_i{}.pth'.format(load_iter*100))))
    netG_B2A.load_state_dict(torch.load(os.path.join(output_weights_path, 'netG_B2A_i{}.pth'.format(load_iter*100))))
    netD_A.load_state_dict(torch.load(os.path.join(output_weights_path, 'netD_A_i{}.pth'.format(load_iter*100))))
    netD_B.load_state_dict(torch.load(os.path.join(output_weights_path, 'netD_B_i{}.pth'.format(load_iter*100))))
